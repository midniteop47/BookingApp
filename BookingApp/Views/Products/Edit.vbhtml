...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.ProductType, New With {.htmlAttributes = New With {.class = "form-control"}})
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.SubCatagoty, New With {.htmlAttributes = New With {.class = "form-control"}})
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.ServiceType, New With {.htmlAttributes = New With {.class = "form-control"}})
